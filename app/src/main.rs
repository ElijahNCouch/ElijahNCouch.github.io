    ...
    rsx! {
        ...
        div { class: "wrap",
            ...
            footer {
                ...
                div { class: "colophon",
                    "This site is written in Rust and compiled to WebAssembly with Dioxus. The layout, content, theme toggle, and every demo on this page run as WASM in your browser."
                    br {}
                    "© 2026 Elijah Couch"
                }
            }
